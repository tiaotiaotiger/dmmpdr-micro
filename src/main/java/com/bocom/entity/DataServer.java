...
public class DataServer {
	...
	public DataServer(String serverName,String description,String ipAddr,String port,String loginName,String loginPwd,
			String netProtocol,String instanceName,String sechemaName,String implClassName,String admLevel,
			String areaType,String areaTypeName,String status,Date lastOfflineTime,
			String dataType,String createBy,String createByOrg,Date createTime,String remark){
		this.serverName=serverName;
		this.description=description;
		this.ipAddr=ipAddr;
		this.port=port;
	...
	public DataServer(String id, String serverName, String description,
